$(document).ready(function() {
    ...
    $.getJSON("/product/favors/product.json",
        function(data) {
            ...
            $.each(data, function(key, value) {
                ...
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_55 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_56 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_57 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_58 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_59 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_60 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_61 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_62 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_63 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_64 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_65 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_66 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_67 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_68 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_69 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_70 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_71 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_72 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_73 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_74 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_75 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_76 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_77 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_78 + '">'
                product_container += '</div>'
                product_container += '<div class="col-lg-3 col-md-4 col-sm-6 mb-2">'
                product_container += '<img class="img-fluid" id="image_54" src="' + value.image_79 + '">'
                product_container += '</div>'
                product_container += '</div>'
            });
